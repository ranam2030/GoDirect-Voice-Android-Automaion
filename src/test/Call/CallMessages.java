...
import AutomationTest.GoDirectVoiceAndroid.Messages.MessageDelete;
...
public class CallMessages extends Base {
	...
	public void CallMessageTest() throws InterruptedException, IOException {
		...
		new MessageDelete().SelectMsgThread();
		
		message.MessagesCall.click();
