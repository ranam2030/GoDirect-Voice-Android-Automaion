...
import AutomationTest.GoDirectVoiceAndroid.Keypad.KeypadNumberTypePrefix;
...
public class CallKeypadPrefix extends Base {
	@Test
	public void CallKeypadTest() throws InterruptedException, IOException {
		...
		Thread.sleep(4000);
		new KeypadNumberTypePrefix().NumberTypeKeypadPrefix();
		Thread.sleep(4000);
