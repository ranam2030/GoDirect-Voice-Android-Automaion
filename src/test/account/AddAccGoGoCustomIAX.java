...
public class AddAccGoGoCustomIAX extends Base{
	...
	public void GoDirectVoiceTest() throws InterruptedException, IOException {
		...
		public void AddGoGoCusIAXAcc() throws InterruptedException{
		...
		account.GogoCustom.click();						// Click to select Iridium custom 
		account.ExtSelect.click();
		//account.ExtSelect.clear();
		account.ExtSelect.sendKeys(TestDataAccount.gogoext[2]);
		driver.hideKeyboard();
		...
		account.DomainSelect.sendKeys(TestDataAccount.gogodom[1]);
		driver.hideKeyboard();
