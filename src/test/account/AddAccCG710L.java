...
public class AddAccCG710L extends Base{
//	public static final String EXTENSION_RANGE_EXCEED = "Try extensions ranging 600-654";
...
/* private void RangValidation() throws InterruptedException {	
	...
	public void AddCG710LAcc() throws InterruptedException {
		...
		account.ExtSelect.click();
		account.ExtSelect.clear();
		account.ExtSelect.sendKeys(TestDataAccount.Honext[6]);
		driver.hideKeyboard();
