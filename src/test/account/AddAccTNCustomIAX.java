...
public class AddAccTNCustomIAX extends Base{
	@Test
	...
	public void AddCustomIAXAcc() throws InterruptedException{
		...
		account.ExtSelect.sendKeys(TestDataAccount.TNext[3]);
		driver.hideKeyboard();
		
		account.PassSelect.click();
		account.PassSelect.sendKeys(TestDataAccount.TNpass[1]);
		driver.hideKeyboard();
		
		account.DomainSelect.click();
		account.DomainSelect.sendKeys(TestDataAccount.TNdom[1]);
		driver.hideKeyboard();
