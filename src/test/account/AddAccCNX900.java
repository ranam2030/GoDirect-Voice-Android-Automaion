...
public class AddAccCNX900 extends Base {
	@Test
	...
	public void AddCNX900Acc() throws InterruptedException{
		...
		account.ExtSelect.sendKeys(TestDataAccount.Honext[1]);
		driver.hideKeyboard();
