...
public class AddAccSDRCustomIAX extends Base{
	...
	public void GoDirectVoiceTest() throws InterruptedException, IOException {
		...
		public void AddSDRCusIAXAcc() throws InterruptedException{
		...
		account.SDRCustom.click();						// Click to select Iridium custom 
		account.ExtSelect.click();
		//account.ExtSelect.clear();
		account.ExtSelect.sendKeys(TestDataAccount.sdrext[2]);
		driver.hideKeyboard();
