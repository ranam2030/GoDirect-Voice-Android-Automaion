...
public class AddAccCG710GD extends Base {
	//public static final String EXTENSION_RANGE_EXCEED = "Try extensions ranging 301-354";
...
/* private void RangValidation() throws InterruptedException {	
	...
	public void AddCG710GDAcc() throws InterruptedException {
		...
		account.ExtSelect.click();
		account.ExtSelect.clear();
		account.ExtSelect.sendKeys(TestDataAccount.Honext[4]);
		driver.hideKeyboard();
