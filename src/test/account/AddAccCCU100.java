...
public class AddAccCCU100 extends Base{
	//public static final String EXTENSION_RANGE_EXCEED = "Try extensions ranging 600-690";
...
/*private void RangValidation() {	
	...
	public void AddCCU100Acc() throws InterruptedException{
		Thread.sleep(1000);
		...
		account.ExtSelect.click();
		account.ExtSelect.clear();
		account.ExtSelect.sendKeys(TestDataAccount.Honext[7]);
		driver.hideKeyboard();
