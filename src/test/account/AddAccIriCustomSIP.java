...
public class AddAccIriCustomSIP extends Base{
	...
	public void GoDirectVoiceTest() throws InterruptedException, IOException {
		...
		public void AddIriCusSipAcc() throws InterruptedException{
		...
		//Utilities proto = new Utilities (driver);
		//proto.ScrollText("IAX");
